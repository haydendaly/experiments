...
const tileContents = [
  {
    title: "Myth: Hand sanitizer is as good as soap",
    icon: soapBottle,
    color: "#f49876",
    details: [
      "Washing your hands with soap for at least 20 seconds is the best way to avoid the virus. Soap breaks down the virus, and lubricates the virus away from the skin. If soap is not available, using an alcohol-based sanitizer gel is your next best option - ensure that every corner of your hands are soaked with the gel. Any sanitizer gel you use should be at least 60% alcohol.",
    ],
    sources: [
      {
