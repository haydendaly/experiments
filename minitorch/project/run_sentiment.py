...
class CNNSentimentKim(minitorch.Module):
    ...
    def __init__(
        ...
        self.layer1 = Linear(feature_map_size, 1)
    ...
    def forward(self, embeddings):
        ...
        conv_batch, conv_feature_map_size, conv_sentence_length = l1.shape
        l1 = l1.view(conv_batch, conv_feature_map_size, 1, conv_sentence_length)
        l2 = l2.view(conv_batch, conv_feature_map_size, 1, conv_sentence_length)
        l3 = l3.view(conv_batch, conv_feature_map_size, 1, conv_sentence_length)

        kernel_size = (1, conv_sentence_length)
        l1 = minitorch.maxpool2d(l1, kernel_size)
        l2 = minitorch.maxpool2d(l2, kernel_size)
        l3 = minitorch.maxpool2d(l3, kernel_size)

        x = (l1 + l2 + l3).view(conv_batch, conv_feature_map_size)
