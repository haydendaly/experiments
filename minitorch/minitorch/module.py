class Module:
    ...
    def named_parameters(self, prefix=""):
        ...
        Args:
            prefix (str, optional): Prefix string for parameter names.
        ...
        if prefix:
            prefix += "."
        result = [(prefix + key, value) for key, value in self._parameters.items()]
        for key, module in self._modules.items():
            result += module.named_parameters(prefix + key)
        return result
